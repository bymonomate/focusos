    ...
    <main className={`min-h-screen text-zinc-900 transition-colors ${
      ...
      <section className="mx-auto max-w-6xl px-4 py-6 md:px-6 md:py-8">
          ...
          action={
            focusMode ? null : (
              <div className="flex flex-wrap gap-2">
                ...
                <button onClick={() => addTask('today')} className="inline-flex items-center gap-2 rounded-2xl border-2 border-dashed border-zinc-300 px-4 py-3 text-sm font-medium text-zinc-600 transition hover:bg-zinc-50"><InlineIcon name="add" className="h-4 w-4" />오늘 할 일 추가</button>
              </div>
            )
          }
        >
        ...
        <section className={focusMode ? "hidden" : ""}><SectionCard
          eyebrow="Later"
          title="나중에 할 일"
          action={<button onClick={() => addTask('later')} className="inline-flex items-center gap-2 rounded-2xl border-2 border-dashed border-zinc-300 px-4 py-3 text-sm font-medium text-zinc-600 transition hover:bg-zinc-50"><InlineIcon name="add" className="h-4 w-4" />나중에 할 일 추가</button>}
        >
          <div className="space-y-4">
